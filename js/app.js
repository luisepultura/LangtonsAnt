...
(function UMD(name, context, definition) {
    if (typeof module !== 'undefined' && module.exports) { module.exports = definition(); }//works for Node
    else if (typeof define === 'function' && define.amd) { define(definition); }//works for amd
    else { context[name] = definition(name, context); }//works for browser

})('Langton', this, function DEF(name, context) {
    //'use strict';
    var hello = function() {
        console.log('hello');
    };
